      ...
      Drupal.behaviors.tiqumFooter = {
        attach: function attach(context) {
          ...
          $(document).on('click', '.form-wewillfind-footer button[type=submit]', function () {
            ...
            if (valid) {
              //submit code here
              var $button = $('.form-wewillfind-footer input[type=submit].webform-button--submit');
...
/***/ "./src/blocks/modules/media-page/media-page.js":
/*!*****************************************************!*\
  !*** ./src/blocks/modules/media-page/media-page.js ***!
  \*****************************************************/
/***/ (function() {
...
(function ($) {
  ...
  var mvpStaff = {
    ...
    'Веб-сервис': ['Frontend Developer (Web)'],
    'Мобильное приложение': ['Mobile Frontend Developer (iOS)', 'Mobile Frontend Developer (Android)'],
    'add': {
        ...
        if (currentWhat) {
          ...
          if (currentWhat === 'Веб-сервис') {
            if (mvpStaff.hasOwnProperty(currentWhat)) {
              ...
              (_teamArray = teamArray).push.apply(_teamArray, _toConsumableArray(mvpStaff[currentWhat]));
            }
            ...
            if (mvpStaff.hasOwnProperty(currentWhat)) {
              ...
              (_teamArray2 = teamArray).push.apply(_teamArray2, _toConsumableArray(mvpStaff[currentWhat]));
            }
            ...
            if (mvpStaff.hasOwnProperty('Веб-сервис')) {
              ...
              (_teamArray3 = teamArray).push.apply(_teamArray3, _toConsumableArray(mvpStaff['Веб-сервис']));
            }

            if (mvpStaff.hasOwnProperty('Мобильное приложение')) {
              var _teamArray4;

              (_teamArray4 = teamArray).push.apply(_teamArray4, _toConsumableArray(mvpStaff['Мобильное приложение']));
            }
          ...
          if (jsonArray.hasOwnProperty('add')) {
            ...
            jsonArray['add'].forEach(function (value) {
              if (mvpPrices[currentWhat]['add'].hasOwnProperty(value)) {
                ...
                Object.assign(tempDetailsAdd, _defineProperty({}, value, mvpPrices[currentWhat]['add'][value]));
              }
...
/* harmony import */ var _modules_media_page_media_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! %modules%/media-page/media-page */ "./src/blocks/modules/media-page/media-page.js");
/* harmony import */ var _modules_media_page_media_page__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_media_page_media_page__WEBPACK_IMPORTED_MODULE_8__);
